    ...
    <div className="bg-rodeo-dark text-rodeo-cream font-sans">
      ...
      <footer className="border-t border-white/10 px-6 py-12 pb-24 md:pb-12 bg-black/20">
        <div className="max-w-4xl mx-auto flex flex-col items-center gap-6">
          ...
          <a href="https://www.instagram.com/elpiqueapp/" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold transition-all hover:opacity-90"
            style={{ background: "linear-gradient(135deg,rgba(193,53,132,0.15),rgba(131,58,180,0.15))", border: "1px solid rgba(193,53,132,0.3)", color: "#E1306C" }}>
