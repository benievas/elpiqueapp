...
import { Save, Loader, Bell, Shield, Globe } from "lucide-react";
  ...
  return (
    <div className="space-y-8 max-w-2xl">
      ...
      <div className="liquid-panel p-6 space-y-5">
        ...
        <div>
          <label className="text-xs text-rodeo-cream/50 font-bold uppercase tracking-widest block mb-1.5">Email</label>
          <input
            type="text"
            value={user?.email || ""}
            disabled
      ...
      <div className="liquid-panel p-6 opacity-50">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h2 className="text-base font-bold text-rodeo-cream/50">Link público</h2>
          <span className="text-xs bg-white/10 text-rodeo-cream/40 px-2 py-0.5 rounded-full">Próximamente</span>
        </div>
